    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bet_side', models.CharField(choices=[('low', 'Low'), ('gold', 'Gold'), ('high', 'High')], max_length=8)),
                ...
                ('result_side', models.CharField(choices=[('low', 'Low'), ('gold', 'Gold'), ('high', 'High')], max_length=8)),
