    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bet_side', models.CharField(choices=[('under', 'Under'), ('dead', 'Dead'), ('over', 'Over')], max_length=8)),
                ...
                ('result_side', models.CharField(choices=[('under', 'Under'), ('dead', 'Dead'), ('over', 'Over')], max_length=8)),
