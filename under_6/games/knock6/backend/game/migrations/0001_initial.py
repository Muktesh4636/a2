    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bet_side', models.CharField(choices=[('clear', 'Clear'), ('pair', 'Pair')], max_length=8)),
                ...
                ('result_side', models.CharField(choices=[('knocked', 'Knocked'), ('clear', 'Clear'), ('pair', 'Pair')], max_length=8)),
