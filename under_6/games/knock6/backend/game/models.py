...
class Round(models.Model):
    class BetSide(models.TextChoices):
        CLEAR = "clear", "Clear"
        PAIR = "pair", "Pair"

    class ResultSide(models.TextChoices):
    ...
    bet_side = models.CharField(max_length=8, choices=BetSide.choices)
    ...
    result_side = models.CharField(max_length=8, choices=ResultSide.choices)
