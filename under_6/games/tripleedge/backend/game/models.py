...
class Round(models.Model):
    ...
    card3_label = models.CharField(max_length=2)
    card3_value = models.PositiveSmallIntegerField()
    card3_symbol = models.CharField(max_length=2)
    card3_red = models.BooleanField(default=False)
