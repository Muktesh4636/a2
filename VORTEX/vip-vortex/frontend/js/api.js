/**
 * VIP Vortex API — JWT optional + /api/vip-vortex/
 */
const API_BASE = (() => {
  const host = location.hostname;
  if (host === "127.0.0.1" || host === "localhost") {
    return "http://127.0.0.1:8151/api";
  }
  return `${location.origin}/api/vip-vortex`;
})();
...
export const postReset = () => api("/reset/", { method: "POST", body: {} });
