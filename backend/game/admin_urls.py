...
urlpatterns = [
    ...
    path('players/create/', admin_views.create_player, name='create_player'),
    ...
    # Legacy worker URLs → redirect via admin_management
    ...
    path('agents/', admin_views.agent_management, name='agent_management'),
    path('agents/create/', admin_views.create_agent, name='create_agent'),
    path('agents/<int:agent_id>/', admin_views.agent_details, name='agent_details'),
    path('agents/<int:agent_id>/edit/', admin_views.edit_agent, name='edit_agent'),
    path('agents/<int:agent_id>/toggle-active/', admin_views.toggle_agent_status, name='toggle_agent_status'),
    path('franchise-balance/', admin_views.franchise_balance, name='franchise_balance'),
    path('franchise-balance/details/<int:admin_id>/', admin_views.franchise_admin_details, name='franchise_admin_details'),
    path('franchise-balance/details/<int:admin_id>/players/', admin_views.franchise_admin_players, name='franchise_admin_players'),
