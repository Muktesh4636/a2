...
def dice_control(request):
    """Dice control page - V7 DEBUG MODE"""
    from django.http import HttpResponse
    return HttpResponse("<html><body style='background:white;color:black;padding:20px;'><h1>v7 DEBUG: Page Loaded Successfully</h1><p>If you see this, the server is running and the view is reachable.</p><p>The error is likely in the database queries or template rendering.</p></body></html>")
