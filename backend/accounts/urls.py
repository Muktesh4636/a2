...
urlpatterns = [
    ...
    path('deposits/mode/', views.deposit_mode, name='deposit_mode'),
    path('deposits/auto/initiate/', views.auto_deposit_initiate, name='auto_deposit_initiate'),
    path('deposits/auto/status/<int:session_id>/', views.auto_deposit_status, name='auto_deposit_status'),
    path('deposits/auto/active/', views.auto_deposit_active, name='auto_deposit_active'),
