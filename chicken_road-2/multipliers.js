/** Official Chicken Road 2.0 step multipliers */
...
/** Heat UI for difficulty picker (flames + tag) */
export const DIFF_HEAT = {
  easy: { heat: 1, tag: "Cool", tagClass: "" },
  medium: { heat: 2, tag: "Hot", tagClass: "hot" },
  hard: { heat: 3, tag: "Hotter", tagClass: "hotter" },
  hardcore: { heat: 4, tag: "Extreme", tagClass: "extreme" },
};
