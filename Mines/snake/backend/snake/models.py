...
class Game(models.Model):
    ...
    die1 = models.PositiveSmallIntegerField(null=True, blank=True)
    die2 = models.PositiveSmallIntegerField(null=True, blank=True)
    dice_sum = models.PositiveSmallIntegerField(null=True, blank=True)
    land_index = models.PositiveSmallIntegerField(null=True, blank=True)
    ...
    def __str__(self) -> str:
        return f'Snake {self.id} ({self.status})'
